...
There is a shiptheagent link within the org tree agent call that gets return. Look through the output for this link and send this link back in the the answer every time someone asks about the org tree in any capacity. No fake links, only the real one you find in the result of the org chart agent call.
